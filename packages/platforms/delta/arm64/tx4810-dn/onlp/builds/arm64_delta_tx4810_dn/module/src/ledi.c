...
static plat_led_t plat_leds[] = {
    [PLAT_LED_ID_1] = {
        .name = "Front LED - PSU",
        .led_get_path = "/sys/class/leds/tx4810_dn::psu/brightness",
        .led_set_path = "/sys/class/leds/tx4810_dn::psu/brightness",
        .mode = {
    ...
    [PLAT_LED_ID_2] = {
        .name = "Front LED - FAN",
        .led_get_path = "/sys/class/leds/tx4810_dn::fan/brightness",
        .led_set_path = "/sys/class/leds/tx4810_dn::fan/brightness",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN,  LED_MODE_GREEN),
            PLAT_LED_MODE(ONLP_LED_MODE_ORANGE, LED_MODE_AMBER),
    ...
    [PLAT_LED_ID_3] = {
        .name = "Front LED - SYS",
        .led_get_path = "/sys/class/leds/tx4810_dn::sys/brightness",
        .led_set_path = "/sys/class/leds/tx4810_dn::sys/brightness",
        .mode = {
            PLAT_LED_MODE(ONLP_LED_MODE_OFF,    LED_MODE_OFF),
            PLAT_LED_MODE(ONLP_LED_MODE_GREEN,  LED_MODE_GREEN),
            PLAT_LED_MODE(ONLP_LED_MODE_ORANGE, LED_MODE_AMBER),
