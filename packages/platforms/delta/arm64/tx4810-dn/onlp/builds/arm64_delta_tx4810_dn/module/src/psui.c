...
static plat_psu_t plat_tx4810_dn_psus[] = {
    [PLAT_PSU_ID_1] = {
        .name = "PSU1",
        .present = _psu_present,
        .present_path = "/sys/bus/i2c/devices/1-0041/psu1_present",

        .power_status_path = "/sys/bus/i2c/devices/1-0041/psu1_powergood",
    ...
    [PLAT_PSU_ID_2] = {
        .name = "PSU2",
        .present = _psu_present,
        .present_path = "/sys/bus/i2c/devices/1-0041/psu2_present",

        .power_status_path = "/sys/bus/i2c/devices/1-0041/psu2_powergood",
...
{
    if (gPlat_id == PID_TX4810_DN)
        return plat_tx4810_dn_psus;
    else
        return NULL;
}
