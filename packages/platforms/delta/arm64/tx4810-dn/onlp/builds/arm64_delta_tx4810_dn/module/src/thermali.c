...
static plat_thermal_t plat_thermals[] = {
    ...
    [PLAT_THERMAL_ID_8] = {
        .name = "Thermal Sensor %d - Near to CPU",
    ...
    [PLAT_THERMAL_ID_8] = {
        .name = "Thermal Sensor %d - Near to SFP",
        .temp_get_path     = "/sys/bus/i2c/devices/1-004c/hwmon/*/temp1_input",

        .warning_get_path  = "/sys/bus/i2c/devices/1-004c/hwmon/*/temp1_max_hyst",
        .critical_get_path = NULL,
        .shutdown_get_path = "/sys/bus/i2c/devices/1-004c/hwmon/*/temp1_max",
