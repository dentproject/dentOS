...
static plat_psu_t plat_tn48m_poe_dn_psus[] = {
    [PLAT_PSU_ID_1] = {
        ...
        .pmbus_insert_cmd = "echo tn48m_poe_dn_psu 0x5b > /sys/bus/i2c/devices/i2c-0/new_device",
    ...
    [PLAT_PSU_ID_2] = {
        ...
        .pmbus_insert_cmd = "echo tn48m_poe_dn_psu 0x5a > /sys/bus/i2c/devices/i2c-0/new_device",
...
static plat_psu_t* get_plat_psu()
{
    if (gPlat_id == PID_TN48M_DN)
        return plat_tn48m_dn_psus;
    else if (gPlat_id == PID_TN48M_POE_DN)
        return plat_tn48m_poe_dn_psus;
    else
        return plat_tn4810m_dn_psus;
}
