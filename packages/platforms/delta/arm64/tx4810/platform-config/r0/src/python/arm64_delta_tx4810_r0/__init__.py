...
class OnlPlatform_arm64_delta_tx4810_r0(OnlPlatformDelta,
                                         OnlPlatformPortConfig_48x10):
    PLATFORM='arm64-delta-tx4810-r0'
    MODEL="TX4810"
    SYS_OBJECT_ID=".48.14"

    def baseconfig(self):
        # Insert platform drivers
        self.insmod("arm64-delta-tx4810-cpld.ko")
        self.insmod("arm64-delta-tx4810-led.ko")
        ...
        # Set OOB LED behavior by the TX4810 HW SPEC
