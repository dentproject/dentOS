...
#include "qsa72-aom-a-48p-sys_cpld_reg.h"
#include "qsa72-aom-a-48p-sys_cpld_sysfs.h"
...
static struct attribute *misc_attributes[] = {
    ...
    SYSFS_ATTR_PTR(phy_s_rst_n                ),
    SYSFS_ATTR_PTR(phy_m_rst_n                ),
    SYSFS_ATTR_PTR(mac_s_rst_n                ),
    SYSFS_ATTR_PTR(tpm_rst_n                  ),
    SYSFS_ATTR_PTR(oob_rst_n                  ),
    SYSFS_ATTR_PTR(mac_m_rst_n                ),
    SYSFS_ATTR_PTR(a385_sysrst_in_n           ),
    SYSFS_ATTR_PTR(a7040_sysrst_in_n          ),
    SYSFS_ATTR_PTR(pd69200_rst_n              ),
    SYSFS_ATTR_PTR(pca9548_rst_n              ),
    SYSFS_ATTR_PTR(tca9539_rst_n              ),
    SYSFS_ATTR_PTR(tpm_int_n                  ),
    SYSFS_ATTR_PTR(oob_int_n                  ),
    SYSFS_ATTR_PTR(xint_out                   ),
    SYSFS_ATTR_PTR(lm75_int2_l                ),
    SYSFS_ATTR_PTR(lm75_int1_3_l              ),
    ...
    SYSFS_ATTR_PTR(fan_sel                    ),
    SYSFS_ATTR_PTR(fan1_tach                  ),
    SYSFS_ATTR_PTR(fan2_tach                  ),
    SYSFS_ATTR_PTR(a385_cpld1_bz              ),
    SYSFS_ATTR_PTR(a7040_cpld1_bz             ),
    SYSFS_ATTR_PTR(mb_cpld1_irq_n             ),
    SYSFS_ATTR_PTR(cpld1_irq_msk              ),
    SYSFS_ATTR_PTR(sys_led                    ),
    SYSFS_ATTR_PTR(cpld1_rev_cap              ),
    SYSFS_ATTR_PTR(cpld1_rev_sub              ),
    SYSFS_ATTR_PTR(gpio_led_ctrl_sfp          ),
    SYSFS_ATTR_PTR(pg_55v_1                   ),
    SYSFS_ATTR_PTR(pg_55v_0                   ),
    SYSFS_ATTR_PTR(pg_12v_1                   ),
    SYSFS_ATTR_PTR(pg_12v_0                   ),
    SYSFS_ATTR_PTR(x_disable_ports            ),
    SYSFS_ATTR_PTR(system_ok                  ),
    SYSFS_ATTR_PTR(a7040_gpio0_int_msk        ),
    SYSFS_ATTR_PTR(tpm_int_msk                ),
    SYSFS_ATTR_PTR(oob_int_msk                ),
    SYSFS_ATTR_PTR(xint_int_msk               ),
    SYSFS_ATTR_PTR(lm75_int2_msk              ),
    SYSFS_ATTR_PTR(lm75_int1_3_msk            ),
    SYSFS_ATTR_PTR(a7040_gpio0_int_proc       ),
    SYSFS_ATTR_PTR(tpm_int_proc               ),
    SYSFS_ATTR_PTR(oob_int_proc               ),
    SYSFS_ATTR_PTR(xint_int_proc              ),
    SYSFS_ATTR_PTR(lm75_int2_proc             ),
    SYSFS_ATTR_PTR(lm75_int1_3_proc           ),
    NULL
};
...
static int system_cpld_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
    ...
    printk(KERN_INFO "%s: 48P System CPLD created.\n", __FUNCTION__);
...
static int system_cpld_remove(struct i2c_client *client)
{
    ...
    printk(KERN_INFO "%s: 48P System CPLD removed.\n", __FUNCTION__);
    return 0;
}

static struct i2c_driver system_cpld_driver = {
    .driver = {
        .name = "qsa72_48p_sys_cpld",
        .owner = THIS_MODULE,
    },
...
MODULE_DESCRIPTION("Driver for 48p system CPLD");
