...
_onlp_fani_info_get_fan(int fid, onlp_fan_info_t* info)
{
	...
	/* set fan fid */
	sprintf(path, "%s%s", PREFIX_PATH_ON_MAIN_BOARD, "fan_sel");
    ...
    sprintf(path, "%s""fan1_tach", PREFIX_PATH_ON_MAIN_BOARD);
    ...
    /* get rear fan speed */
    memset(path, 0, sizeof(path));
    sprintf(path, "%s""fan2_tach", PREFIX_PATH_ON_MAIN_BOARD);
